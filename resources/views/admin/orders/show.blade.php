<div class="box box-info">
  ...
  <div class="box-body">
    <table class="table table-bordered">
      ...
      <tr>
        <td colspan="4">
          <form class="form-inline" action="{{ route('admin.orders.ship', $order->id) }}" method="post">
            {{ csrf_field() }}
      ...
      <tr>
        ...
        <td>
          ...
          <button class="btn btn-success btn-sm" id="btn-refund-agree">同意</button>
          <button class="btn btn-danger btn-sm" id="btn-refund-disagree">不同意</button>
          @endif
        </td>
      </tr>
      @endif
